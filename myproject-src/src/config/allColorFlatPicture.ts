export const allColorFlatPicture = ({
  client_id,
  load_img,
  text,
  lora_name,
    ...
    prompt: {
      ...
      '145': {
        inputs: {
          ...
          emphasis: 0.75,
          append: true,
          text: '(normal quality), (low quality), (worst quality)',
        },
        ...
        workflow: {
          ...
          nodes: [
            ...
            },
            {
              ...
              widgets_values: [input_seed, 'randomize', 15, 8, 'euler_ancestral', 'normal', 1],
            },
            {
              id: 71,
            ...
            },
            {
              ...
              widgets_values: ['On', lora_name, lora_weight, lora_clip],
            },
            {
              id: 77,
              type: 'LoadImage',
              ...
              mode: 0,
              outputs: [
                { name: 'IMAGE', type: 'IMAGE', links: [175], shape: 3, slot_index: 0 },
