...
export const material_process = ({ client_id, load_img, mask_img, material_img, text }: any) => {
  ...
  return {
    ...
    prompt: {
      ...
      '24': {
        inputs: { image: material_img, upload: 'image' },
        class_type: 'LoadImage',
      },
      '26': {
        inputs: {
        ...
        workflow: {
          ...
          nodes: [
            ...
            },
            {
              ...
              properties: { 'Node name for S&R': 'LoadImage' },
              widgets_values: [material_img, 'image'],
            },
            {
              id: 4,
