...
const Draw = () => {
  ...
  useEffect(() => {
    ...
    if (check_history_data?.promptId) {
      ...
      set_classifyId2(check_history_data.classifyId2 ?? allClassify[3]?.children?.[0]?.id);
      const index = allClassify[3]?.children.findIndex(
      ...
      if (!classifyId2) {
        set_classifyId2(allClassify[3]?.children?.[0]?.id);
      }
      if (!classifyId3) {
        set_classifyId3(allClassify[3]?.children?.[0]?.children?.[0]?.id);
      }
    }
  ...
  const { run: start_task } = useDebounceFn(
    async (num) => {
      ...
      const params = {
        ...
        text: promptTxt,
        classifyId1: allClassify[3]?.id,
        classifyWord1: allClassify[3]?.name,
        classifyId2: classifyId2,
        classifyWord2: allClassify[3]?.children[classifyId2_index]?.name,
        cnStrength,
      ...
      if (classifyId3 == -1 && style_img) {
        ...
        const classify2List = allClassify[3]?.children[classifyId2_index].children;
        ...
        <div className="draw-left">
          ...
          <div className="space">
            ...
            <div className="select">
              <Select
                ...
                onChange={(e) => {
                  set_classifyId2(e);
                  const index = allClassify[3]?.children.findIndex((v) => v.id == e);
                  set_classifyId2_index(index);
                  set_classifyId3(allClassify[3]?.children?.[index]?.children?.[0]?.id);
                }}
                placeholder={t('请选择空间')}
              >
                {allClassify[3]?.children.map((v) => {
                  return (
          ...
          <div className="style">
            ...
            <div className="style-content">
              ...
              {allClassify[3]?.children?.[classifyId2_index]?.children?.map((v, i) => {
                return (
                  <Popover
                    content={
                      <img
