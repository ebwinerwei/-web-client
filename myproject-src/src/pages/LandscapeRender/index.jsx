...
const Draw = () => {
  ...
  useEffect(() => {
    ...
    if (check_history_data?.promptId) {
      ...
      set_classifyId2(check_history_data.classifyId2 ?? allClassify[1]?.children?.[0]?.id);
      const index = allClassify[1]?.children.findIndex(
      ...
      if (!classifyId2) {
        set_classifyId2(allClassify[1]?.children?.[0]?.id);
      }
      if (!classifyId3) {
        set_classifyId3(allClassify[1]?.children?.[0]?.children?.[0]?.id);
      }
      if (view == '') {
  ...
  const { run: start_task } = useDebounceFn(
    async (num) => {
      ...
      const params = {
        ...
        text: [strPromptedit(promptTxt), atmosphere, environment].filter((v) => Boolean(v.length)).join(','),
        classifyId1: allClassify[1]?.id,
        classifyWord1: allClassify[1]?.name,
        classifyId2: classifyId2,
        classifyWord2: allClassify[1]?.children[classifyId2_index]?.name,
        cnStrength,
      ...
      if (classifyId3 == -1 && style_img) {
        ...
        const classify2List = allClassify[1]?.children[classifyId2_index].children;
        ...
        <div className="draw-left">
          ...
          <div className="space">
            ...
            <div className="select">
              <Select
                ...
                onChange={(e) => {
                  set_classifyId2(e);
                  const index = allClassify[1]?.children.findIndex((v) => v.id == e);
                  set_classifyId2_index(index);
                  set_classifyId3(allClassify[1]?.children?.[index]?.children?.[0]?.id);
                }}
                placeholder={t('请选择空间')}
              >
                {allClassify[1]?.children.map((v) => {
                  return (
          ...
          <div className="style">
            ...
            <div className="style-content">
              ...
              {allClassify[1]?.children?.[classifyId2_index]?.children?.map((v, i) => {
                return (
                  <Popover
                    content={
                      <img
              ...
              <div className="bottom">
                ...
                <div className="content">
                  <div className="pic-item">
                    <img
                      src={
                        'https://blue-1304000175.cos.ap-tokyo.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E5%BB%BA%E7%AD%91AI/%E6%99%AF%E8%A7%82%E8%AF%A6%E6%83%85%E9%A1%B5/su%E6%88%AA%E5%9B%BE.jpeg'
                      }
                      className="picture"
                    />
                  ...
                  <div className="pic-item">
                    <img
                      src={
                        'https://blue-1304000175.cos.ap-tokyo.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E5%BB%BA%E7%AD%91AI/%E6%99%AF%E8%A7%82%E8%AF%A6%E6%83%85%E9%A1%B5/%E5%AE%9E%E6%99%AF%E5%9B%BE.jpeg'
                      }
                      className="picture"
                    />
                  ...
                  <div className="pic-item">
                    <img
                      src={
                        'https://blue-1304000175.cos.ap-tokyo.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E5%BB%BA%E7%AD%91AI/%E6%99%AF%E8%A7%82%E8%AF%A6%E6%83%85%E9%A1%B5/%E5%BD%A9%E7%BB%98.jpeg'
                      }
                      className="picture"
                    />
                  ...
                  <div className="pic-item">
                    <img
                      src={
                        'https://blue-1304000175.cos.ap-tokyo.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E5%BB%BA%E7%AD%91AI/%E6%99%AF%E8%A7%82%E8%AF%A6%E6%83%85%E9%A1%B5/%E6%89%8B%E7%BB%98%E7%BA%BF%E7%A8%BF.jpeg'
                      }
                      className="picture"
                    />
