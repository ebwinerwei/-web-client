...
const angle_list = [
  { label:'極めて薄い', value: 50 },
  { label:'薄い', value: 60 },
  { label:'少し薄い', value: 70 },
  { label:'少し濃い', value: 75 },
  { label:'濃い', value: 80 },
  { label:'極めて濃い', value: 95 },
];
...
const Draw = () => {
  ...
  const [cnStrength, set_cnStrength] = useState(70);
  ...
  const { run: start_task } = useDebounceFn(
    async () => {
      ...
      if (!upload_img) {
        ...
        //set_upload_img('blue-user-1304000175.cos.ap-tokyo.myqcloud.com/1744687502980_1683806_.png');
        return;
      }
      if (!style_img) {
      ...
      const params = {
        ...
        classifyId1: allClassify[24]?.id,
        classifyWord1: allClassify[24]?.name,
              ...
              {!style_img ? (
                <Upload
                  ...
                  beforeUpload={(file) => {
                    ...
                    if (!isImg) {
                      message.error(t(`色見の参考画像をアップロードしてください`));
                      return false;
                    }
                    if (img_size > 10) {
                ...
                >
                  <div className="item-wrapper">
                    ...
                    <div className="plus-label">{t('色見の参考画像をアップロードしてください')}</div>
                  </div>
                </Upload>
              ) : (
                <div className="style-item" onClick={() => set_classifyId3(-1)}>
                  ...
                  <div className="label">{t('色見の参考画像')}</div>
                </div>
              )}
            </div>
          </div>
          <div className="angle">
            <div className="label" >{t('色見の濃い度設定：')}</div>
            ...
            <div className="right">
              ...
              <div className="bottom">
                ...
                <div className="title2">
                  {t('ご指定の外壁の箇所に対し、色見参考画像から取得した色を、AI技術により最適な色で配色いたします。')}
                </div>
                <div className="content">
                  <div className="pic-item">
                    <img
                      ...
                      className="picture"
                    />
                    <div className="name">{t('配色前の画像')}</div>
                  </div>
                  <i className="iconfont icon-down-jiantou" />
                  <div className="pic-item">
                    <img
                      src={
                        'https://blue-1304000175.cos.ap-tokyo.myqcloud.com/Eva%e7%9b%b8%e5%85%b3%2feva_imgs%2fweb%2fai%e8%af%a6%e6%83%85%e9%a1%b5%e5%8f%b3%e4%be%a7%2f%e9%80%9a%e7%94%a8AI%2fcolorchange%2fcolorai.png'
                      }
                      className="picture"
                    />
                    <div className="name">{t('AIで配色後の画像')}</div>
                  </div>
                </div>
              </div>
            </div>
