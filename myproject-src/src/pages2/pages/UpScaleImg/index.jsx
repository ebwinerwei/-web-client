  ...
  useEffect(() => {
    ...
    if (img) {
      ...
      imgNode.onload = () => {
        ...
        if (imgNode.width > 1500 || imgNode.height > 1500) {
          message.info('图片尺寸不得大于1500，请先进行无损压缩');
          return;
        }
        set_upload_img(img);
      };
  ...
  const { run: start_task } = useDebounceFn(
    async () => {
      ...
      const res = await startTask({
        ...
        scale,
        classifyId1: allClassify[13]?.id,
        classifyWord1: allClassify[13]?.name,
      });
      message.destroy();
      if (res.error.errorCode == 0 && res.data?.taskId != null) {
        setNumber((res.data.queueNum + 1) * 35 + 25);
              ...
              <div className="left">
                ...
                <div className="bottom-draw">
                  <div className="left-wrapper">
                    {/* <Row style={{ alignItems: 'center', width: 600 }}>
                      <Col span={4} className="label">
                        提升倍数:
                      </Col>
                      <Col span={16}>
                        <Select style={{ width: 200 }} value={scale} onChange={(e) => set_scale(e)}>
              ...
              <div className="right">
                ...
                <div className="bottom">
                  ...
                  <div className="title2">
                    {t('不仅提升清晰度，更能提升图片细节和质感（光纤、阴影等）')}
                  </div>
                  <div className="content">
                    <div className="pic-item">
                      <img
                        src={
                          'https://eva-1313581156.cos.accelerate.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E9%80%9A%E7%94%A8AI/%E6%B8%85%E6%99%B0%E5%BA%A6/%E6%B8%85%E6%99%B0%E5%BA%A61.jpeg'
                        }
                        className="picture"
                      />
                    ...
                    <div className="pic-item">
                      <img
                        src={
                          'https://eva-1313581156.cos.accelerate.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E9%80%9A%E7%94%A8AI/%E6%B8%85%E6%99%B0%E5%BA%A6/%E6%B8%85%E6%99%B02.png'
                        }
                        className="picture"
                      />
