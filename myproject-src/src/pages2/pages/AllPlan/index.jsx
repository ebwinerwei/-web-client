...
const Draw = () => {
  ...
  const [plan_type, set_plan_type] = useState(1);
  ...
  const { run: start_task } = useDebounceFn(
    async () => {
      ...
      const res = await startTask({
        ...
        type: plan_type,
        classifyId1: allClassify[17]?.id,
        classifyWord1: allClassify[17]?.name,
      });
      message.destroy();
            ...
            <div style={{ display: 'flex', height: '96%' }}>
                    ...
                    <Row style={{ alignItems: 'center', width: 600 }}>
                      ...
                      <Col span={16}>
                        <Select
                          style={{ width: 200 }}
                          value={plan_type}
                          onChange={(e) => set_plan_type(e)}
                        >
                          <Select.Option value={1}>{t('风格')} 1</Select.Option>
                          {/* <Select.Option value={2}>风格 2</Select.Option> */}
                          <Select.Option value={3}>{t('风格')} 2</Select.Option>
                        </Select>
                      </Col>
                    </Row>
                  </div>
              ...
              <div className="right">
                ...
                <div className="bottom">
                  ...
                  <div className="title2">{t('一键生成彩平图，可选择不同风格')}</div>
                  <div className="content">
                    <div className="pic-item">
                      <img
                        src={
                          'https://eva-1313581156.cos.accelerate.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E5%BB%BA%E7%AD%91AI/%E6%80%BB%E5%BD%A9%E5%B9%B3%E5%9B%BE/qq.jpg'
                        }
                        className="picture"
                      />
                    ...
                    <div className="pic-item">
                      <img
                        src={
                          'https://eva-1313581156.cos.accelerate.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E5%BB%BA%E7%AD%91AI/%E6%80%BB%E5%BD%A9%E5%B9%B3%E5%9B%BE/eva_img.jpg'
                        }
                        className="picture"
                      />
