...
const atmosphere_list = [
  ...
  {
    label: '夜晚',
    value: '(in the night,lighting:1.2)',
  },
];
...
const Draw = () => {
  ...
  const [cnStrength, set_cnStrength] = useState(0.4);
  ...
  const [atmosphere, set_atmosphere] = useState('day');
  ...
  useEffect(() => {
    set_classifyId2(allClassify[2]?.children?.[0]?.id);
  }, [allClassify]);
  ...
  const { run: start_task } = useDebounceFn(
    async (num) => {
      ...
      const params = {
        ...
        classifyId1: allClassify[2]?.id,
        classifyWord1: allClassify[2]?.name,
        cnStrength,
        ignoreWordAndImage: ignoreWordAndImage,
      };
      if (classifyId2 == -1 && style_img) {
        params.ipadapterImgage = `https://${style_img}`;
      } else {
        params.classifyId2 = classifyId2;
        params.classifyWord2 = allClassify[2]?.children[classifyId2_index]?.name;
      }
      message.loading({
        type: 'loading',
        content: t('开始设置，请稍等...'),
      ...
      <div className="birdsViewRender">
        <div className="draw-left">
          ...
          <div className="style">
            ...
            <div className="style-content">
              {/* <div className="style-item">
                {!style_img ? (
                  ...
                  <div className="style-item" onClick={() => set_classifyId2(-1)}>
                    <div className="item-wrapper">
              ...
              {allClassify[2]?.children?.map((v, i) => {
                return (
                  <Popover
                    content={
                      <img
            ...
            <div className="angle">
              <div className="space-title">氛围：</div>
            ...
            <div className="left">
              ...
              <div className="bottom-draw">
                <div className="left-wrapper">
                  ...
                  <div className="slide">
                    <Slider min={0.1} step={0.05} max={1} onChange={onChange} value={cnStrength} />
                  </div>
                </div>
              ...
              <div className="bottom">
                ...
                <div className="content">
                  <div className="pic-item">
                    <img
                      src={
                        'https://eva-1313581156.cos.accelerate.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E5%BB%BA%E7%AD%91AI/%E5%A4%A7%E9%B8%9F%E7%9E%B0%E8%AF%A6%E6%83%85%E9%A1%B5/%E5%BD%A9%E7%BB%98.jpg'
                      }
                      className="picture"
                    />
                  ...
                  <div className="pic-item">
                    <img
                      src={
                        'https://eva-1313581156.cos.accelerate.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E5%BB%BA%E7%AD%91AI/%E5%A4%A7%E9%B8%9F%E7%9E%B0%E8%AF%A6%E6%83%85%E9%A1%B5/%E6%89%8B%E7%BB%98%E7%BA%BF%E7%A8%BF.jpg'
                      }
                      className="picture"
                    />
