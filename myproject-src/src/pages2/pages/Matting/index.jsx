  ...
  const { run: start_task } = useDebounceFn(
    async () => {
      ...
      const params = {
        ...
        classifyId1: allClassify[15]?.id,
        classifyWord1: allClassify[15]?.name,
      };
      message.loading({
        type: 'loading',
        content: t('开始设置，请稍等...'),
            ...
            <div style={{ display: 'flex', height: '96%' }}>
              ...
              <div className="right">
                ...
                <div className="bottom">
                  ...
                  <div className="title2">{t('纯色背景图，一件抠图png（稍微复杂的背景也能）')}</div>
                  <div className="content">
                    <div className="pic-item">
                      <img
                        src={
                          'https://eva-1313581156.cos.accelerate.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E9%80%9A%E7%94%A8AI/%E6%8A%A0%E5%9B%BE/%E6%8A%A0%E5%9B%BE1.jpg'
                        }
                        className="picture"
                      />
                    ...
                    <div className="pic-item">
                      <img
                        src={
                          'https://eva-1313581156.cos.accelerate.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E9%80%9A%E7%94%A8AI/%E6%8A%A0%E5%9B%BE/%E6%8A%A0%E5%9B%BE2.jpg'
                        }
                        className="picture"
                      />
