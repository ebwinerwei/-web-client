...
const Draw = () => {
  ...
  const [x_size, set_x_size] = useState(128);
  const [y_size, set_y_size] = useState(128);
  ...
  const { run: start_task } = useDebounceFn(
    async () => {
      ...
      const params = {
        ...
        classifyId1: allClassify[14]?.id,
        classifyWord1: allClassify[14]?.name,
        width: x_size,
        height: y_size,
      };
      message.loading({
            ...
            <div style={{ display: 'flex', height: '96%' }}>
                ...
                <div className="bottom-draw">
                  <div className="left-wrapper">
                    <div style={{ alignItems: 'center', display: 'flex' }}>
                      <div className="label">{t('横向扩图尺寸：')}</div>
                      <Select className="select" value={x_size} onChange={(e) => set_x_size(e)}>
                        <Select.Option value={0}>0px</Select.Option>
                        <Select.Option value={64}>64px</Select.Option>
                        <Select.Option value={128}>128px</Select.Option>
                        <Select.Option value={256}>256px</Select.Option>
                      </Select>
                      <div className="label">{t('纵向扩图尺寸：')}</div>
                      <Select className="select" value={y_size} onChange={(e) => set_y_size(e)}>
                        <Select.Option value={0}>0px</Select.Option>
                        <Select.Option value={64}>64px</Select.Option>
                        <Select.Option value={128}>128px</Select.Option>
                        <Select.Option value={256}>256px</Select.Option>
              ...
              <div className="right">
                ...
                <div className="bottom">
                  ...
                  <div className="title2">{t('自动联想图片空间构造')}</div>
                  <div className="content">
                    <div className="pic-item">
                      <img
                        src={
                          'https://eva-1313581156.cos.accelerate.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E9%80%9A%E7%94%A8AI/%E6%89%A9%E5%9B%BE/%E6%89%A9%E5%9B%BE1.jpg'
                        }
                        className="picture"
                      />
                    ...
                    <div className="pic-item">
                      <img
                        src={
                          'https://eva-1313581156.cos.accelerate.myqcloud.com/Eva%E7%9B%B8%E5%85%B3/eva_imgs/web/ai%E8%AF%A6%E6%83%85%E9%A1%B5%E5%8F%B3%E4%BE%A7/%E9%80%9A%E7%94%A8AI/%E6%89%A9%E5%9B%BE/%E6%89%A9%E5%9B%BE2.jpg'
                        }
                        className="picture"
                      />
